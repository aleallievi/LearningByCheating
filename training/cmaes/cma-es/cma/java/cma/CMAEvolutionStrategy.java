...
public class CMAEvolutionStrategy implements java.io.Serializable {
     ...
     * 
     */
    public final String versionNumber = new String("0.99.22"); 
    
    /** Interface to whether and which termination criteria are satisfied 
     */
    public class StopCondition implements java.io.Serializable {
	private static final long serialVersionUID = 2918241407634253526L;
    	...
    	int test() { 
    		...
    		/* Condition number */
    		if (math.min(diagD) == 0)
    			appendMessage("ConditionNumber: smallest eigenvalue equals zero");
    ...
    /* fitness information */
    class FitnessCollector implements java.io.Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 2918241407634253526L;
    ...
    public double[] init() {
    	...
    	if (options.diagonalCovarianceMatrix < 0) // necessary for hello world message
    		options.diagonalCovarianceMatrix = 1 * 150 * N / sp.lambda; // cave: dublication below
...
//                    parseDouble(getAllToken(properties.getProperty("boundaryUpper"))));
    ...
    class Timing implements java.io.Serializable {
	private static final long serialVersionUID = 2918241407634253526L;
        ...
        long starteigen; // time after flgdiag was turned off, ie when calling eigen() starts
    ...
    */
    ...
    private void updateDistribution(ISolutionPoint[] pop) {
...
//    }
    ...
    private void updateDistribution() {
        ...
        if (options.diagonalCovarianceMatrix == -1) // options might have been re-read
        	flgdiag = (countiter <= 1 * 150 * N / sp.lambda); 
        ...
        if (sp.getCcov() > 0 && iniphase == false) {
            ...
            for (i = 0; i < N; ++i)
                for (j = (flgdiag ? i : 0); 
                    ...
                    * update
                    */
                        C[i][j] += sp.getCcov(flgdiag) * (1 - 1. / sp.getMucov())
                        * sp.getWeights()[k]
...
class IntDouble implements Comparator<IntDouble>, java.io.Serializable {
    private static final long serialVersionUID = 2918241407634253526L; 
