...
class Euclidean implements IObjectiveFunction { // meaning implements methods valueOf and isFeasible
...
public class CMAMyExample {
	public static void main(String[] args) {
		//IObjectiveFunction fitfun = new Rosenbrock();
		IObjectiveFunction fitfun = new Euclidean();
